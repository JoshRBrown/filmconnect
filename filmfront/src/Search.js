...
class Search extends React.Component {
  ...
  _submitSearch = (e) => {
    e.preventDefault();
    fetch(`https://api.themoviedb.org/3/search/movie?api_key=644f21e59b17cbf67e64dbcba7a57278&language=en-US&query=${this.state.search}&page=1&include_adult=false`)
